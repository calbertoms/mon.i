            ...
            <table class="table table-condensed">
                ...
                <thead>
                    <tr>                        
                        ...
                        <th class="col-md-3" style="text-align: center; vertical-align: middle;">Nivel</th>
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    <?php foreach ($tanques as $t) {
                        ...
                        echo '<td style="text-align: center; vertical-align: middle;">'.$t->nivel.'</td>';
                        echo '<td style="text-align: center; vertical-align: middle;">';                   
                        echo '<a style="margin-right: 1%" href="#modalEdit" class="btn btn-info editar" role="button" data-toggle="modal" tanque="'.$t->idTanque.'" title="Editar Tanque Gasoso"><i class="fa fa-fw fa-pencil"></i></a>';                                            
                        if($this->permission->checkPermission($this->session->userdata('permissao'),'gAdministradores')){
                            if($t->status == 1){
                                echo '<a style="margin-right: 1%"href="#modalExcluir" class="btn btn-danger excluir" role="button" data-toggle="modal" idTanque="'.$t->idTanque.'" title="Excluir Tanque Gasoso"><i class="fa fa-fw fa-remove"></i></a>';
                             }else{
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="ModalLabelAdd">Mon.I - Adicionar Tanque Gasoso</h4>
            </div>
            <form id="formCad" action="<?php echo base_url('TanqueGasoso_ctrl/adicionar'); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                           ...
                           <div class="row">
                               <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="pressaoCad">Pressão<span class="required" style="color: #EE0000">*</span>: </label>
                                        <input type="text" class="form-control" id="pressaoCad" name="pressaoCad"/>                       
                                    </div>
                                </div>
                               <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
...
<div id="modalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelAdd">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="ModalLabelAdd">Mon.I - Editar Tanque Gasoso</h4>
            </div>
            <form id="formEdit" action="<?php echo base_url('TanqueGasoso_ctrl/editar'); ?>" method="post">
                <div class="modal-body">                    
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="pressaoEdit">Pressão<span class="required" style="color: #EE0000">*</span>: </label>
                                        <input type="text" class="form-control" id="pressaoEdit" name="pressaoEdit"/>                       
                                    </div>
                                </div>
                               <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
...
<div id="modalExcluir" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelExcl">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="ModalLabelExcl">Mon.I - Excluir Tanque Gasoso</h4>
            </div>
            <form id="formExcluir" action="<?php echo base_url('TanqueGasoso_ctrl/excluir'); ?>" method="post">
                <div class="modal-body">
                    <h5 style="text-align: center">Deseja realmente excluir esse Tanque Gasoso ?</h5>
...
<div id="modalRestaurar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelRestaurar">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formRest" action="<?php echo base_url('TanqueGasoso_ctrl/restaurar'); ?>" method="post">
                <div class="modal-body">
...
$(document).ready(function () {
    ...
    $('#modalEdit').on('shown.bs.modal', function () {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?php echo base_url('TanqueGasoso_ctrl/buscaTanque');?>',
        ...
        messages: 
                {
                    ...
                    pressaoEdit: {required: 'Campo Requerido'},
        ...
        messages: 
                {
                    ...
                    pressaoCad: {required: 'Campo Requerido'},
