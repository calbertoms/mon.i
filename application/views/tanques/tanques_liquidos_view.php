    ...
    <div class="col-sm-12 col-md-12">        
        ...
        <div class="table-responsive">
            <table class="table table-condensed">
                <caption><h2 class="text-center">Gerenciamento de Tanques Líquidos</h2></caption>
                <thead>
                    <tr>                        
...
<div id="modalCad" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelAdd">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formCad" action="<?php echo base_url('TanqueLiquido_ctrl/adicionar'); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                           ...
                           <div class="row">
                               <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="viscosidadeCad">Viscosidade<span class="required" style="color: #EE0000">*</span>: </label>
                                        <input type="text" class="form-control" id="viscosidadeCad" name="viscosidadeCad"/>                       
                                    </div>
                                </div>
                               <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
...
<div id="modalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelAdd">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formEdit" action="<?php echo base_url('TanqueLiquido_ctrl/editar'); ?>" method="post">
                <div class="modal-body">                    
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="row">
                               <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="viscosidadeEdit">Viscosidade<span class="required" style="color: #EE0000">*</span>: </label>
                                        <input type="text" class="form-control" id="viscosidadeEdit" name="viscosidadeEdit"/>                       
                                    </div>
                                </div>
                               <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
...
<div id="modalExcluir" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelExcl">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formExcluir" action="<?php echo base_url('TanqueLiquido_ctrl/excluir'); ?>" method="post">
                <div class="modal-body">
...
<div id="modalRestaurar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelRestaurar">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formRest" action="<?php echo base_url('TanqueLiquido_ctrl/restaurar'); ?>" method="post">
                <div class="modal-body">
   ...
   //carrega os dados do totem
    $('#modalEdit').on('shown.bs.modal', function () {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?php echo base_url('TanqueLiquido_ctrl/buscaTanque');?>',
            ...
            success: function (data)
            {
                ...
                {                    
                    ...
                    $("#viscosidadeEdit").val(data.viscosidade);
        ...
        messages: 
                {
                    ...
                    viscosidadeEdit: {required: 'Campo Requerido'},
        ...
        messages: 
                {
                    ...
                    viscosidadeCad: {required: 'Campo Requerido'},
