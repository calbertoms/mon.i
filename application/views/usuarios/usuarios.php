    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="ModalLabelAdd">GC Automação - Adicionar Usuário</h4>
            </div>
            <form id="formCad" action="<?php echo base_url('Usuarios/adicionar'); ?>" method="post">
...
<div id="modalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelAdd">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="ModalLabelAdd">GC Automação - Editar Usuário</h4>
            </div>
            <form id="formEdit" action="<?php echo base_url('Usuarios/editar'); ?>" method="post">
                <div class="modal-body">                    
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
...
<div id="modalExcluir" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabelExcl">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="ModalLabelExcl">GC Automação - Excluir Usuário</h4>
            </div>
            <form id="formExcluir" action="<?php echo base_url('Usuarios/excluir'); ?>" method="post">
                <div class="modal-body">
...
$(document).ready(function () {
    ...
    $('#modalEdit').on('shown.bs.modal', function () {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?php echo base_url('Usuarios/buscaUsuario');?>',
        ...
        rules:
                {
                    usuarioCad: {required: true,
                               remote: "<?php echo base_url('Usuarios/verificaUsuarioPorNome'); ?>"},
                    emailCad: {required: true,
                               remote: "<?php echo base_url('Usuarios/verificaUsuarioPorEmail'); ?>"},
